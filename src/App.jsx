    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path='/app1/*' element={<App1 data={data} login={login} newOrOldUser={user} refLink={data}/>}/>
                <Route path='/startPage' element={<StartPage data={data[0]} newOrOldUser={user} login={login} func={handleChange}/>}/>
            </Routes>
        </BrowserRouter>
    )
}
...
// Чтобы достичь уровня 185к за каждые 4 часа, нужно прокачать 20 бустов (для начала 5 бустов, далее добавятся новые).
// !!! На главной странице показывается сколько майнится в час. Также сделать бонус за ежедневный вход и придумать еще интересные идеи типа морзе в хаме.