...
function StartPage(props) {
    ...
    console.log(login, user, claims, profit, id)
    ...
    async function startMining(){
        ...
        if(user === "new") await fetch("http://localhost:8888/addNewUserAndStartMining", reqStart); // Если пользователь новый, при нажатии на кноку StartMining отправляется POST запрос на добавление пользователя в БД
